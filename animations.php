...
<img class="films" src="poster/rm.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM serie WHERE id_s = 3 AND id_c = 2");
if($reponse = $requete->fetch())
{
    $titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM serie WHERE id_s = 3 AND id_c = 2");
if($reponse = $requete->fetch())
{
    $description = substr($reponse['description'],0,60)."... <a href='serie/watch.php?titre=Rick et Morty 1&ids=3&idsn=1&ep=1'>Regarder</a>";

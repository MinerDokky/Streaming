...
<img class="films" src="poster/stranger.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM serie WHERE id_s = 2 AND id_c = 6");
if($reponse = $requete->fetch())
{
    $titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM serie WHERE id_s = 2 AND id_c = 6");
if($reponse = $requete->fetch())
{
    $description = substr($reponse['description'],0,60)."... <a href='serie/watch.php?titre=Stranger Things 1&ids=2&idsn=1&ep=1'>Regarder</a>";

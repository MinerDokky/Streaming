...
<img class="films" src="poster/ana.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM film WHERE id_f = 5 AND id_c = 9");
if($reponse = $requete->fetch())
{
	$titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM film WHERE id_f = 5 AND id_c = 9");
if($reponse = $requete->fetch())
{
	$description = substr($reponse['description'],0,60)."... <a href='films/watch.php?titre=Anabelle Création&idf=5'>Regarder</a>";	
}

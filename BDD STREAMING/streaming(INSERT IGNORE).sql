...
INSERT IGNORE INTO `abo` (`id_a`, `datedeb`, `datefin`, `id_u`) VALUES
...
INSERT IGNORE INTO `categorie` (`id_c`, `libelle`) VALUES
	(1, 'action'),
	(2, 'animation'),
	(3, 'aventure'),
	(4, 'comédie'),
...
INSERT IGNORE INTO `critiquef` (`id_c`, `lien`, `id_f`) VALUES
...
INSERT IGNORE INTO `critiques` (`id_c`, `lien`, `id_s`) VALUES
...
INSERT IGNORE INTO `film` (`id_f`, `titre`, `description`, `id_c`) VALUES
...
INSERT IGNORE INTO `lienimgposter` (`id_imp`, `lien`, `id_f`) VALUES
...
INSERT IGNORE INTO `lienimgposters` (`id_imp`, `lien`, `id_s`) VALUES
...
INSERT IGNORE INTO `saison` (`id_sn`) VALUES
	(1);
...
INSERT IGNORE INTO `serie` (`id_s`, `id_sn`, `episode`, `titre`, `id_c`, `description`) VALUES
...
INSERT IGNORE INTO `users` (`id_u`, `login`, `mdp`, `nom`, `prenom`, `mail`, `ip`, `date_inscription`, `datelastco`, `niveau`) VALUES
...
INSERT IGNORE INTO `videof` (`id_v`, `lien`, `id_f`) VALUES
...
INSERT IGNORE INTO `videos` (`id_v`, `lien`, `id_s`, `id_sn`, `episode`) VALUES
...
INSERT IGNORE INTO `vues` (`id_v`, `id_s`, `datevue`, `id_sn`, `titre`, `episode`) VALUES

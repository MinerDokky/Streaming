...
<img class="films" src="poster/break.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM serie WHERE id_s = 5 AND id_c = 5");
if($reponse = $requete->fetch())
{
    $titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM serie WHERE id_s = 5 AND id_c = 5");
if($reponse = $requete->fetch())
{
    $description = substr($reponse['description'],0,60)."... <a href='serie/watch.php?titre=Breaking Bad&ids=5&idsn=1&ep=1'>Regarder</a>";

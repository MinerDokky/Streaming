...
<img class="films" src="poster/coco.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM film WHERE id_f = 9 AND id_c = 2");
if($reponse = $requete->fetch())
{
	$titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM film WHERE id_f = 9 AND id_c = 2");
if($reponse = $requete->fetch())
{
	$description = substr($reponse['description'],0,60)."... <a href='films/watch.php?titre=Coco&idf=9'>Regarder</a>";

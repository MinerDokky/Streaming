...
<img class="films" src="poster/pirate.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM film WHERE id_f = 6 AND id_c = 3");
if($reponse = $requete->fetch())
{
	$titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM film WHERE id_f = 6 AND id_c = 3");
if($reponse = $requete->fetch())
{
	$description = substr($reponse['description'],0,60)."... <a href='films/watch.php?titre=Pirate des Caraibe 5&idf=6'>Regarder</a>";

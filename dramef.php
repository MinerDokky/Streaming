...
<img class="films" src="poster/moonlight.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM film WHERE id_f = 10 AND id_c = 5");
if($reponse = $requete->fetch())
{
	$titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM film WHERE id_f = 10 AND id_c = 5");
if($reponse = $requete->fetch())
{
	$description = substr($reponse['description'],0,50)."... <a href='films/watch.php?titre=Moonlight&idf=10'>Regarder</a>";

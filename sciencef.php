...
<img class="films" src="poster/mars.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM film WHERE id_f = 3 AND id_c = 11");
if($reponse = $requete->fetch())
{
	$titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM film WHERE id_f = 3 AND id_c = 11");
if($reponse = $requete->fetch())
{
	$description = substr($reponse['description'],0,60)."... <a href='films/watch.php?titre=Seul sur mars&idf=3'>Regarder</a>";

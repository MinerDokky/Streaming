...
<img class="films" src="poster/jura.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM film WHERE id_f = 8 AND id_c = 6");
if($reponse = $requete->fetch())
{
	$titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM film WHERE id_f = 8 AND id_c = 6");
if($reponse = $requete->fetch())
{
	$description = substr($reponse['description'],0,50)."... <a href='films/watch.php?titre=Jurassic World 2&idf=8'>Regarder</a>";

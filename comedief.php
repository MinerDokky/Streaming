...
<img class="films" src="poster/garfield.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM film WHERE id_f = 2 AND id_c = 4");
if($reponse = $requete->fetch())
{
	$titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM film WHERE id_f = 2 AND id_c = 4");
if($reponse = $requete->fetch())
{
	$description = substr($reponse['description'],0,60)."... <a href='films/watch.php?titre=garfield&idf=2'>Regarder</a>";	
}

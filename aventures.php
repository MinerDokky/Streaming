...
<img class="films" src="poster/twd.jpg">
<?php
$requete = $bdd->query("SELECT titre FROM serie WHERE id_s = 4 AND id_c = 3");
if($reponse = $requete->fetch())
{
    $titre = $reponse['titre'];
}
$requete = $bdd->query("SELECT description FROM serie WHERE id_s = 4 AND id_c = 3");
if($reponse = $requete->fetch())
{
    $description = substr($reponse['description'],0,60)."... <a href='serie/watch.php?titre=The walking Dead&ids=6&idsn=1&ep=1'>Regarder</a>";
